...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    public void initRenderHandler(final EGLContext shared_context, final int tex_id, boolean isBackCamera, int viewWidth, int viewHeight) {
        mRenderHandler.setEglContext(shared_context, tex_id, mSurface, true, isBackCamera, viewWidth, viewHeight);
    }
