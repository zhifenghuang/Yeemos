...
import com.yeemos.app.view.ReadUserPopuWindow;
...
public class ReadUserListAdapter extends BaseAdapter {

    private ArrayList<BasicUser> arrayList;
    private PostBean postBean;
    private Context mContext;
    private ReadUserPopuWindow readUserPopuWindow;

    public ReadUserListAdapter(Context mContext, PostBean postBean, ReadUserPopuWindow readUserPopuWindow) {
        this.mContext = mContext;
        this.postBean = postBean;
        this.readUserPopuWindow = readUserPopuWindow;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHold viewHold;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.read_user_list_item, null);
    ...
    private void getMoreData(int position) {
        if (position == arrayList.size() / 2) {
            readUserPopuWindow.loadMoreData();
        }
    }
